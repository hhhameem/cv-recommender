...
urlpatterns = [
    ...
    path('jobs/<slug:job_slug>/applications/',
         views.totalApplications, name='totalApplications'),
    path('jobs/<slug:job_slug>/applications/invite/',
         views.sendInvitation, name='sendInvitation'),
