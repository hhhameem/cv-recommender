...
def level_of_education(level_of_education_required, applicant_education_level):
    ...
    if level_of_education_required == 'post graduate' and applicant_education_level == 'post graduate':
        education_level_score = 15
    elif level_of_education_required == 'graduate' and applicant_education_level == 'graduate' or 'post graduate':
        education_level_score = 15
    elif level_of_education_required == 'hsc' and applicant_education_level == 'hsc' or 'graduate' or 'post graduate':
        education_level_score = 15
    elif level_of_education_required == 'ssc' and applicant_education_level == 'ssc' or 'hsc' or 'graduate' or 'post graduate':
        education_level_score = 15
    elif level_of_education_required == 'post graduate' and applicant_education_level == 'ssc' or 'hsc' or 'graduate':
        education_level_score = 10
    elif level_of_education_required == 'graduate' and applicant_education_level == 'ssc' or 'hsc':
        education_level_score = 10
    elif level_of_education_required == 'hsc' and applicant_education_level == 'ssc':
        education_level_score = 10
...
def score_on_education(job, application):
    ...
    '''
    level_of_education_required = job[2]
    cgpa_required = job[3]
    applicant_education_level = application[2]
